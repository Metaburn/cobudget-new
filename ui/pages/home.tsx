...
const ProjectCard = ({ project }) => {
    ...
    return (
        ...
        >
            ...
            <Label
                className={
                    `absolute right-0 m-2 ${project.labelColor}`
                }
            >
                {project.slug}
            </Label>
            <div className="p-4 pt-3 flex-grow flex flex-col justify-between">
                <div className="mb-2">
                    ...
                    <div className="text-gray-800"><span dangerouslySetInnerHTML={{__html: project.summary}} /></div>
                </div>
                <div>
...
const projectCamps = {
    ...
    title: "Camps - קמפים",
    summary: "המקום לקמפים לגייס חברים חדשים לחיים ולחברים למצוא בית\n" +
...
const projectDreams = {
    ...
    title: "Dreams - חלומות",
    summary: "מחפש לבנות ספינת חלל או להצטרף לצוות? זה המקום" +
        "<br/><br/>" +
